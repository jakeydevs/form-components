<fieldset class="{{ $gc('fieldset') }}">
  ...
  <select id="{{ $name }}" name="{{ $name }}" {{ $attributes }} class="focus:ring-indigo-500 focus:border-indigo-500 block rounded-md">
